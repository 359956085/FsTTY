...
use commands::{
    add_command_history, cancel_transfer, check_app_update, clear_command_history,
    close_app_update, configure_local_agents, connect_session, create_remote_directory,
    create_session, delete_remote_entry, delete_session, delete_session_group, disconnect_session,
    download_file, export_command_history, export_mcp_command_policy, forget_host_key,
    get_app_settings, get_command_history_settings, get_device_status, get_mcp_agent_prompt,
